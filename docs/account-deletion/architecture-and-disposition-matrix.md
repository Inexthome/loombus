...
| Notifications | database notifications, email and push delivery | Delivery records exist across internal and vendor systems | Delete or minimize member-addressable records; request vendor deletion where supported | security, delivery disputes | notification routes and migrations | Vendor copies unverified |
