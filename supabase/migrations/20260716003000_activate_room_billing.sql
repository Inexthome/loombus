-- Durable Stripe billing identity and pre-payment checkout intents for Loombus Rooms.
-- Paid rooms are provisioned only after Stripe confirms a completed subscription checkout.
