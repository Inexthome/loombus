...
if (!["LibraryKnowledgeGraphV4Surface", "LibraryKnowledgeGraphV5Surface", "LibraryKnowledgeGraphV6Surface", "LibraryKnowledgeGraphV7Surface"].some((token) => page.includes(token))) throw new Error("Graph route must render v4 or approved successor surface");
