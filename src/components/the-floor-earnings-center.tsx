  ...
  return (
    <main className="min-h-screen bg-[var(--loombus-page-bg)] px-4 pb-24 pt-5 text-[var(--loombus-text)] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-5">
        ...
        {!feedLoading && !market?.earnings.available ? <section className={card}><CalendarDays className="size-6 text-[var(--loombus-gold)]"/><h2 className="mt-3 text-lg font-black">Earnings calendar unavailable</h2><p className="mt-2 text-sm leading-6 text-[var(--loombus-text-muted)]">{market?.earnings.message ?? "The Twelve Data earnings calendar is temporarily unavailable or not included in the current API plan."}</p></section> : null}
