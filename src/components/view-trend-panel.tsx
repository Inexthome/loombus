...
export function ViewTrendPanel({ range }: { range: RangeKey }) {
  ...
  return (
    <>
      ...
      <section className="border-b border-[var(--loombus-border)] py-5" aria-labelledby="view-trend-title">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="text-xs font-bold uppercase tracking-[.16em] text-[var(--loombus-gold)]">
              View trend
            </p>
            <h2 id="view-trend-title" className="mt-2 text-xl font-black">
              Views over time by discussion origin.
            </h2>
            <p className="mt-1 text-sm text-[var(--loombus-text-muted)]">
              Knowledge-origin and regular discussion views are plotted separately. Views remain a reach metric and do not add Signal.
            </p>
          </div>
        ...
        <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 border-t border-[var(--loombus-border)] pt-3 text-xs text-[var(--loombus-text-muted)]">
        ...
        {loading ? (
          ...
          <div className="mt-4">
            <div className="relative h-56 border-y border-[var(--loombus-border)] py-4">
              ...
              <svg
                ...
                role="img"
                aria-label="Views over time for knowledge-origin and regular discussions"
              >
                <polyline
          ...
          <p className="mt-4 border-t border-[var(--loombus-border)] py-6 text-sm text-[var(--loombus-text-muted)]">
            No authenticated discussion views recorded in this period.
          </p>
        )}
      </section>
    </>
