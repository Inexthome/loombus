...
const publicRoutes = [
  ...
  { route: "/discussions", priority: 0.95, changeFrequency: "daily" as const },
  { route: "/library", priority: 0.9, changeFrequency: "weekly" as const },
  { route: "/the-floor", priority: 0.9, changeFrequency: "daily" as const },
  { route: "/topics", priority: 0.85, changeFrequency: "daily" as const },
