...
export const ROOM_MODELS: RoomModel[] = [
  ...
  },
  {
    ...
    description:
      "A private customer space for support questions, known issues, help resources, requests, and product updates.",
    audience: "Businesses, service providers, product teams, and client groups",
    examples: ["Known issues", "Support questions", "Product updates"],
