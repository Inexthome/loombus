  ...
  return (
    <main className="min-h-screen bg-black px-4 pb-24 pt-4 text-white sm:px-6 sm:py-12 lg:py-16 loombus-shell-with-right-rail">
      ...
      <div className="mx-auto max-w-[46rem]">
        ...
        {authChecked && isLoggedIn && (
          <form
            id="loombus-create-discussion-form"
            onSubmit={handleCreate}
            onKeyDown={handleFormKeyDown}
            className="space-y-4 rounded-[1.75rem] border border-zinc-800 bg-zinc-950/90 p-4 shadow-2xl shadow-black/20 sm:space-y-6 sm:p-8"
          >
            <div>
              <p className="mb-4 text-base font-semibold tracking-tight text-zinc-100">
                1. Content & Metadata
              </p>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-zinc-800 bg-black px-5 py-4 text-base text-white outline-none transition placeholder:text-zinc-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="min-h-[22rem] w-full rounded-2xl border border-zinc-800 bg-black px-5 py-4 text-base text-white outline-none transition placeholder:text-zinc-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
            ...
            {/* AI Assist shell */}
            <section className="rounded-2xl border border-zinc-800 bg-black/40 p-3 sm:p-5 lg:hidden">
          ...
          {authChecked && isLoggedIn && (
            <section className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5 shadow-2xl shadow-black/20">
              ...
              <h2 className="text-xl font-semibold tracking-tight">
                Optimize your post before you publish.
              </h2>

              <p className="mt-3 text-sm leading-relaxed text-zinc-500">
                Check quality, rewrite for clarity, and review feedback before posting.
              </p>
