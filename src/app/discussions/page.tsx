          ...
          <section className="mb-5 rounded-2xl border border-zinc-800 bg-zinc-950 p-4 md:hidden">
            <div className="mb-4 flex items-center justify-between gap-3">
              <div>
                ...
                <h2 className="mt-1 text-lg font-medium">Explore signal.</h2>
              </div>
            ...
            <div className="space-y-5">
              <div>
                <div className="mb-2 flex items-center justify-between gap-3">
                  <p className="text-sm font-medium text-zinc-300">Topics</p>

                  <button
                    type="button"
                    onClick={() => setShowAllTopicFilters((current) => !current)}
                  ...
                  >
                    {showAllTopicFilters ? "Fewer" : "More"}
                  </button>
                </div>
...
<section className="mb-6 rounded-3xl border border-zinc-800 bg-zinc-950 p-4 sm:p-6">
          <div className="loombus-desktop-only-discussion-control max-md:!hidden hidden mb-5 flex-col gap-3 md:flex md:flex-row md:items-end md:justify-between">
            <div>
              <p className="mb-2 text-sm uppercase tracking-[0.25em] text-zinc-500">
                Topic discovery
              </p>
        ...
        <section className="loombus-desktop-only-discussion-control max-md:!hidden hidden md:block mb-8 rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex-1">
              ...
              <input
                ...
                className="loombus-desktop-only-discussion-control max-md:!hidden hidden md:block w-full rounded-2xl border border-zinc-800 bg-black px-5 py-4 text-white outline-none transition placeholder:text-zinc-600 focus:border-zinc-600"
              />
            </div>
        ...
        <div className="mb-8">
          ...
          <p className="loombus-desktop-only-discussion-control max-md:!hidden md:block hidden md:block mt-3 text-xs leading-relaxed text-zinc-600">
            Signal Score ranks discussions using replies, saves, and views.
            Replies count more than views, and saves count the most.
          </p>
        </div>

        <section className="loombus-desktop-only-discussion-control max-md:!hidden hidden md:block mb-6 rounded-3xl border border-zinc-800 bg-zinc-950 p-4 sm:p-6">
        ...
        <div className="loombus-desktop-only-discussion-control-flex max-md:!hidden mb-5 hidden flex-wrap gap-2 sm:mb-6 sm:gap-3 md:flex">
          {topics.map((topic) => (
            <button
              key={topic}
              onClick={() => setTopicFilter(topic)}
