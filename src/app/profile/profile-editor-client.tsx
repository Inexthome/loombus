    ...
    <main className="min-h-screen bg-black px-4 pb-24 pt-4 text-white sm:px-6 sm:py-12 lg:py-16">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mb-5 text-sm leading-relaxed text-zinc-400 sm:mb-8 sm:text-base">
          Manage your public identity, creator tools, profile preview, and sharing options.
        </p>

        <section data-profile-workspace-section="overview" className="mb-5 rounded-2xl border border-zinc-800 bg-zinc-950 p-4 sm:mb-6 sm:p-5">
        ...
        <div className="grid gap-4 sm:gap-5 lg:grid-cols-[minmax(0,1fr)_340px] lg:gap-6">
          ...
          >
          <section data-profile-workspace-section="overview" className="rounded-2xl border border-zinc-900 bg-black p-4 sm:p-5">
          ...
          <section data-profile-workspace-section="public" className="space-y-4 sm:space-y-5">
            <div>
              <h2 className="text-xl font-medium sm:text-2xl">
                Public profile
              </h2>
          ...
          <section data-profile-workspace-section="creator" className="space-y-4 border-t border-zinc-900 pt-5 sm:space-y-5 sm:pt-8">
          ...
          <section hidden aria-hidden="true" className="border-t border-zinc-900 pt-5 sm:pt-8">
          ...
          <div data-profile-save-controls>
          <button
            type="submit"
            disabled={saving}
          ...
          <aside data-profile-workspace-section="preview" className="h-fit rounded-2xl border border-zinc-800 bg-zinc-950 p-4 sm:p-6">
