    ...
    <main className="createRoomAppearance fixed inset-0 z-[80] min-h-screen overflow-y-auto bg-[#f7f7f8] loombus-v2-page-bg text-slate-950">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 pt-7 sm:px-6 lg:px-8">
        ...
        <section className="mt-8 rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">After subscription, the available room choices should appear inside the private room dashboard on /rooms.</p>
            </div>
          </div>
        ...
        <section className="mt-8 grid gap-4 rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6 lg:grid-cols-3">
          {[
            ["1", "Subscribe", "Pick the plan that matches the room size and features."],
            ["2", "Choose setup", "After subscription, show the available templates and plan choices in /rooms."],
